...
public class VoteFingerprintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Fingerprint Authentication");
        ...
        biometricPrompt = new BiometricPrompt(VoteFingerprintActivity.this,
            ...
            public void onAuthenticationSucceeded(@NonNull BiometricPrompt.AuthenticationResult result) {
                ...
                startActivity(new Intent(VoteFingerprintActivity.this, VoteNowActivity.class));
