...
import com.project.firebaseapplication.databinding.ActivityPhoneVerificationBinding;
import com.project.firebaseapplication.databinding.ActivityPhoneVerificationOtpVerifyBinding;
        ...
        referenceProfile.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (readUserDetails != null) {
                    ...
                    Toast.makeText(PhoneVerificationActivity.this, "Something went wrong!", Toast.LENGTH_LONG).show();
                }
    ...
    private void otpSend() {
        ...
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(authProfile)
                        .setPhoneNumber("+91" + binding.editTxtPhone.getText().toString().trim())
